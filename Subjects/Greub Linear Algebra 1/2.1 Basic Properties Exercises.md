...
Conversely, suppose there exists a linear map ${} \chi :G \to{}E {}$ with ${} \psi \circ  \chi =\iota {}$. We showed above that this corresponds to a complementary subspace $\im \chi$ of ${} F=\ker \psi=\im \varphi {}$, so ${} E=\im \chi \oplus  \ker \psi {}$. Now given ${} E\ni e=m+k,\, m \in \im  \chi,\, k \in \ker \psi {}$, let ${} \omega : E \to{}F {}$ ${} \omega e=k {}$. This is well defined and clearly linear. Now since $\varphi$ is injective, and ${} k \in \ker \psi=\im \varphi {}$, then $\omega$ is surjective. So given ${} f \in F {}$, there exists some ${} e \in E {}$ with ${} \omega e=f {}$, so there exists some ${} k \in \ker  \psi {}$ with ${} \omega k=f {}$. Now $\omega\varphi\omega k= {}$