...
9. 
Suppose there exists a linear map ${} \omega: E \to{}F {}$ with ${} \omega \circ  \varphi = \iota {}$. Now let ${} f \in F {}$. Then we have ${} \varphi(f)\in E {}$ with ${} \omega\varphi f=f {}$, so $\omega {}$ is surjective. 