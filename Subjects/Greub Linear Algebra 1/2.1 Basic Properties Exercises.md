...
Now let ${} Z \in H_{i\,j+1} {}$. Then there exists some ${} f \in \im  \varphi_{ i\,j} \cap \ker  \psi_{i\,j+1} {}$ with ${} Z=f+\varphi_{i\,j} [\ker \psi_{i\,j}] {}$. Now we have some ${} b \in E_{i\,j} {}$ with ${} \varphi_{ij} b = f {}$. Let ${} e = \psi_{ij} {}$. Note that ${} \varphi_{i+1 \,j} e = \varphi_{i+1\,j} \psi_{ij} b = \psi_{i\,j+1} \varphi_{ij} b = \psi_{i\,j+1}f=0 {}$, so ${} e \in \ker \varphi_{i+1\,j} {}$. Therefore, ${} X=e+\psi_{i\,j}[\ker \varphi_{i\,j}] \in H_{i+1\,j} {}$. Now ${} \theta(X)=\varphi_{i\,j} \left[ \psi_{i\,j} ^{-1}[e+\psi_{i\}] \right] {}$