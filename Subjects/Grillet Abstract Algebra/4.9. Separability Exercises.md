...
3. 
Suppose that ${} F$ is separable over $K$, and $E$ is separable over $F$. Then let ${} L=K(\alpha_{1},\,\dots,\,\alpha_{n}) \subseteq E {}$ with ${} \alpha_{i} \in E {}$ be a finitely generated intermediate field. Then there are

Let ${} (\alpha_{i})_{i \in I} \subseteq E {}$ be linearly independent over ${} K$. 