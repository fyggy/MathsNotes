...
3. 
We have that there are either ${} 1$ Sylow $3$-subgroup of $G$, or $7$. If there are $7 {}$, then since they are all cyclic, they are all disjoint, so we have ${} 21 {}$ elements of order ${} 3$. But ${} |1|=1 {}$, so this is impossible. Therefore, there is one Sylow ${} 3 {}$-subgroup, and it is normal. Clearly, it has a normal Sylow $7$-subgroup, so 
4. 
