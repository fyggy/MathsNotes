...
Finally, let ${} U=S^{-1}A {}$. Clearly, $U {}$ is an automorphism. Since $\Phi {}$ is algebraically closed, then there exists an eigenvector ${} e {}$ of ${} A {}$ with eigenvalue $\alpha {}$. Now note that
$$
\begin{align}
 (U-I)e   & =Ue-e \\
 & =S\alpha e-e \\
 ...
 \end{align}
$$
Therefore, all the eigenvalues of $U-I {}$ are 0, so it is nilpotent