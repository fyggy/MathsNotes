...
13. skip
14. Let $p$ be prime. First, working ${} (\Rightarrow ) {}$. Let ${} \sigma \in S_{n}$ have order $p$. We work by induction on the number of cycles $\sigma$ is composed of. Now we have a $n$-cycle ${} \sigma^{i}(x)=s$ ${} \sigma^{i}(x) {}$ ${} \sigma i(x)= {}$
