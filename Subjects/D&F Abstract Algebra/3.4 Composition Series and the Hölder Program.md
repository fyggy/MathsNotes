...
11. 
Let $G$ be a solvable group, and let $H\lhd G$ be non-trivial. Now $N$ and ${} G /N =\bar{G} {}$ are solvable, so we have
$$
1= N_{0}\lhd N_{1} \lhd \dots\lhd N_{a} = N
$$
with ${} N_{k+1}/N_{k} {}$ abelian, and 
$$
N=M_{0} \lhd M_{1} \lhd_{}\dots\lhd M_{b} = G
$$
in particular, 

Let ${} \mathcal{N} {}$ be the set of normal subgroups of ${} G {}$, and let ${} U = \bigcap_{K\in \mathcal{N}} K  {}$. 