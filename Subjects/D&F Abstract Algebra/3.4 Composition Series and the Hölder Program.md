...
$$
1 \trianglelefteq M_{1} \cap N_{r-1}\trianglelefteq N_{r-1} \trianglelefteq M_{1} N_{r-1} \trianglelefteq G
$$
...
$$
N_{r-1} / (M_{1} \cap N_{r-1})\cong M_{1} N_{r-1} / M_{1}=N_{r-1} /M_{1}
$$
