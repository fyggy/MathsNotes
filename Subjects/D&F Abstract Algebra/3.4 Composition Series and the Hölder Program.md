...
$$
\begin{align}
 g[N,\, N]g^{-1} & =\{ gxyx^{-1}y^{-1}g^{-1} \mid x,\, y \in N \}   \\
 & =\{ gxg^{-1}gyg^{-1}gx^{-1}g^{-1}gy^{-1}g^{-1} \mid x,\, y \in N \} \\
 & =\{ aba^{-1}b^{-1} \mid a,\,b \in N \} \\
 & =N
 \end{align}
$$
...
Now let $G$ be a solvable group. Then there exists a solving series, ie
$$
G = N_{0} \rhd N_{1} \rhd N_{2} \rhd\dots \rhd N_{r}= 1
$$
with ${} N_{k} / N_{k+1} {}$ abelian. Now 