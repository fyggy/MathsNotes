...
11. 
Let $G$ be a solvable group, and let $H\lhd G$ be non-trivial. Let $n$ be the length of the shortest solvable sequence of $G {}$. Suppose by induction that every solvable group ${} G' {}$ with a solvable sequence of length ${} k<n {}$ has, for all non-trivial normal subgroups $H' {}$, a non-trivial subgroup of ${} H' {}$ that is normal in ${} G' {}$ and is abelian.

If ${} n=1 {}$, then $G$ is abelian, so $H\lhd G$ is non-trivial, a subgroup of $H$, and abelian.

Otherwise, ${} G /H {}$ is solvable, and has a solving chain of length $k<n {}$. Therefore, There exists a 
