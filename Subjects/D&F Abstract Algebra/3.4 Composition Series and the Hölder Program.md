...
In both cases, ${} N_{r-1} {}$ is simple, so it is the last non-trivial subgroup in the chain. Therefore, ${} r=2 {}$, and ${} N_{r-1}=N_{1} {}$. Now we have that either $N_{1}=M_{1} {}$, or ${} N_{1} = G/M_{1} {}$. We have 2 cases:
${} N_{1}=M_{1} {}$, and ${} G / N_{1}=G / M_{1} {}$,
