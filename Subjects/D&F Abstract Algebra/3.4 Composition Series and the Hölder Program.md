...
By the lattice isomorphism theorem, every ${} G_{k} {}$ that contains $N$ corresponds to a subgroup of ${} G /N {}$, specifically $\bar{G_{k}} {}$, and ${} \conj{G_{k+1}} / \conj{G_{k}}=(G _{k+1} / N) / (G_{k} /N)\cong G_{k+1} /G_{k} {}$, so is abelian.