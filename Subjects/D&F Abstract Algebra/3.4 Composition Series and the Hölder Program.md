...
11. 
Let $G$ be a solvable group, and let $H\lhd G$ be non-trivial. Let $n$ be the length of the shortest solvable sequence of $G$. Suppose by induction that every solvable group with a solvable sequence of length $k<n {}$ has a 