...
Otherwise, ${} n>1 {}$, so ${} N_{r-1}\lhd G {}$ and ${} M_{s-1} \lhd G {}$. Consider the subgroup ${} H=N_{r-1} \cap M_{s-1} {}$. Then ${} H \lhd G {}$, ${} H \lhd N_{r-1} {}$, and ${} H \lhd M_{s-1} {}$. Also note that the subgroup ${} K = N_{r-1} M_{s-1} {}$ is normal in $G$. Consider the quotient
$$
\begin{align}
 G / K  & \cong (G / N_{r-1})   / (N_{r-1} M_{s-1} / N_{r-1}) \\
