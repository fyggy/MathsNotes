...
$$
So ${} M_{s-1} N_{r-1} = G {}$. 
WLOG suppose that $s\leq r {}$. Now since ${} H \lhd M_{s-1} {}$, then there exists a composition chain of ${} M_{s-1} {}$ containing $H$. Therefore, $H$ has a composition chain of length ${} k \leq n-1 <n {}$. Therefore, for any composition chain of $H$, they all have the same length, and the composition factors are unique up to permutation. Let
$$
H =H_{a}\rhd H_{a-1}\rhd \dots \rhd H_{1} \rhd H_{0} = 1
$$
be a composition chain of $H {}$. Now we have that
$$
