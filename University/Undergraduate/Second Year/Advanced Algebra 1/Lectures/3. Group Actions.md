...
#### Example:
Let ${} S_{n}  {}$ act on ${} \{ 1,\,\dots,\,n \}=X {}$. For any ${} i,j \in X {}$, there exists some ${} \sigma \in S_{n} {}$ with ${} \sigma \cdot i=j {}$  and ${} \sigma \cdot j =i {}$ and ${} \sigma \cdot k=k$ for all other ${} k \in X {}$. Therefore, ${} X= G \cdot j {}$ for any $j$, and there is only $1 {}$ orbit. This action is then called *transitive* ${} \circlearrowleft  $
#### Example:
