...
$$
If you're paying attention, you may notice this as exactly the relations for the Lie algebra ${} \mathfrak{sl}_{2}(\mathbb{C}) {}$. Thanks to the magical representation theory of ${} \mathfrak{sl}_{2}(\mathbb{C}) {}$, there exists a basis for $\mathfrak{g}$ such that $\ad \mathbf{h}_{\alpha} {}$ is diagonal; recall that in the original example, then ${} h=\begin{pmatrix}1 & 0 \\ 0 & -1 \end{pmatrix}  {}$. In fact, since ${} \mathfrak{h} {}$ is abelian, then
$$
