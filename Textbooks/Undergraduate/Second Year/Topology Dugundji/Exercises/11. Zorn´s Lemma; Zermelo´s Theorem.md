...
$$
x=\sum _{b \in \mathcal{B}} bq_{b}
$$
for ${} q_{b} \in \mathbb{Q} {}$. Define ${} \theta:\mathbb{R} \to{}\mathbb{C} {}$ by
$$
\begin{align}
 \theta(x)= \theta\left( \sum_{b\in \mathcal{B}} b q_{b} \right) =\sum _{b \in \mathcal{B}}q_{b} f(b)
 \end{align}
$$
If we now have ${} y=\sum_{b\in \mathcal{B}} bp_{b} {}$ for ${} p_{b} \in \mathbb{Q} {}$, then 
$$
...
${} \mathfrak{c} \mathfrak{A} \mathscr{D} \mathcal{A}  {}$