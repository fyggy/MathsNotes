...
Finally, let ${} (A,\, \prec _{A}) \in \mathscr{F} {}$. Then ${} A \subseteq U {}$, and $\prec _U$ induces $\prec _A$ on $A$. Finally, let ${} y \in U {}$ with ${} y \notin A {}$. Then if ${} x \in A {}$, then ${} y \in B {}$ with $B \succ A {}$. Therefore, ${} x \prec_{U} y {}$, and ${} (A,\, \prec _{A})< {}$
