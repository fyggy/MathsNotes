...
Therefore, $\mathscr{G}$ is a $\varphi$-spire, and since ${} \mathscr{G} \subseteq \mathscr{M} {}$, then ${} \mathscr{G}=\mathscr{M} {}$, and $\mathscr{M}$ is totally ordered by continuation, and is a non-decreasing chain. Therefore, ${} A=\bigcup \mathscr{M} \in \mathscr{M} {}$, and ${} A \cup \{ \varphi(A) \} \in M {}$. Therefore, ${} A \cup  \{ \varphi(A) \} \subseteq A {}$, and ${} \varphi(A) \in A {}$.
...
1. ${} \varnothing  \in \mathscr{F} {}$
2. 
If ${} \mathscr{A} \subseteq \mathscr{F}' {}$ is a chain ordered by continuation, then given any ${} a,\, b \in \bigcup \mathscr{A} {}$, there exists well ordered sets ${} A,\, B \in \mathscr{A} {}$ with ${} a \in A {}$, and ${} b \in B {}$. Therefore, ${} a,\, b \in  A \cup B {}$, and so either ${} a \succ b {}$ or ${} b \succ a {}$, so ${} \bigcup \mathscr{A} {}$ is totally ordered. 

Now let ${} A \subseteq  \bigcup \mathscr{A} {}$. Let $m$ be the first element of ${} B \in \mathscr{A} {}$. Since $\mathscr{A}$ is ordered by continuation, then $m$ is the first element of all ${} B \in \mathscr{A} {}$. 