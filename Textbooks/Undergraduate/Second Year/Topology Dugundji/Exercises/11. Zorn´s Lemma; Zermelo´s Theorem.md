...
8. 
Let $\mathcal{B}$ be a basis for $\mathbb{R}$ over $\mathbb{Q}$. Now let ${} \prec  {}$ be a well order on $\mathcal{B} {}$. Let ${} x=\sum q_{n} b_{n} {}$ for ${} q_{n} \in \mathbb{Q} {}$, and ${} b_{n} \in \mathcal{B} {}$. 
${} a_{12}3 {}$
${} a_{b^{2}}^{2}sd {}$
$$
a_{123}3
