...
Now let ${} x,\, y \in X {}$, with $x\neq y {}$. Then there exists a set ${} A \in \mathscr{A} {}$ containing $x$ as otherwise, ${} \mathscr{A}\cup \left\{ \bigcup \mathscr{A} \cup \{ x \}\right\} {} {}$ would be larger than $\mathscr{A}$. Likewise, there exists a set ${} B \in \mathscr{A} {}$ containing $y$. Now suppose that, for all ${} x \in A \in \mathscr{A} {}$, ${} y \in A {}$, and for all ${} y \in B \in \mathscr{A} {}$, then ${} x \in B {}$. 