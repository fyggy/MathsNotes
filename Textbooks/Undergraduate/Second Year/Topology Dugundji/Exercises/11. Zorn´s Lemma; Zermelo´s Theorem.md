...
Finally, let ${} S \subseteq X {}$. For each ${} x,\, y \in S {}$, there exists a set ${} A(x,\, y) \in \mathscr{A}$ such that either
$$
\begin{align}
 & x \in A(x,\, y),\, y \notin A(x,\, y), \text{ or} \\
 & x \notin A(x,\, y),\, y \in A(x,\, y), 
\end{align}
$$
Now let ${} A=\bigcap \{ A(x,\, y) \mid x,\, y \in S \} \in \mathscr{A} {}$. Suppose that ${} A=\varnothing  {}$. Then for each ${} x \in S {}$, there exists some ${} A(a,\, b) \not\ni x {}$.