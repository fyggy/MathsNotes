...
$$
A< B \iff \forall x \in A: \exists y \in B:x \prec y \text{ and } \forall x \in B:\exists y
$$
...
Now let ${} A \in \mathscr{A} {}$, and ${} x \in Z {}$. Then ${} x \in B {}$ for some ${} B \in \mathscr{A} {}$. Suppose that $B<A$. Then there exists some $$