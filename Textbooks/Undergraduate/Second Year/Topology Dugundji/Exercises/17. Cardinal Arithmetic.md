...
$$
Conversely, suppose that $\aleph_{1}^{\aleph_{0}} < \aleph_{2}^{\aleph_{0}} {}$. Then if ${} \aleph_{1} \neq 2^{\aleph_{0}} {}$, we have 2 cases. The first is that $2^{\aleph_{0}}> \aleph_{1} {}$. Then
$$
2^{\aleph_{0}}\leq (2^{\aleph_{0}})^{\aleph_{1}}=2^{\aleph_{1}}\leq 2^{2^{\aleph_{0}}}
$$
