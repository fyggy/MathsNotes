...
13. skip
14. 
($a\Rightarrow b {}$) Let ${} U \subseteq X {}$ be open. Then if ${} y \in A=\{ y \in Y\mid p^{-1}(y) \subseteq Y \} {}$, there exists some open ${} V \subseteq Y {}$ such that ${} p^{-1}(y) \subseteq p^{-1}(V) \subseteq U {}$. Therefore, 